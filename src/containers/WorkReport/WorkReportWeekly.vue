    ...
    <Card>
      ...
      <Row>
        <Col span="12" style="text-align: center;">
          开始时间 <DatePicker v-model="startTime" type="date" :options="options" placeholder="Select date" style="width: 200px" format="yyyy-MM-dd"></DatePicker>
        </Col>
        <Col span="12" style="text-align: center;">
          结束时间 <DatePicker type="date" :value="endTime" placeholder="Select date" style="width: 200px" format="yyyy-MM-dd" disabled></DatePicker>
        </Col>
      </Row>
          ...
          <table cellpadding="0" cellspacing="0">
            ...
            <tbody>
              <tr v-for="(item, index) in weeklySummary">
                <td><Input type="textarea" placeholder="" v-model="item.workPlan"></Input></td>
                <td><Input type="textarea" placeholder="" v-model="item.work"></Input></td>
                <td><Input type="textarea" placeholder="" v-model="item.difference"></Input></td>
                <td>
                  <Row>
                    <Col span="14">
      ...
      <Row>
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tr v-for="(item, index) in nextWeekPlane">
            <td><Input type="textarea" placeholder="" v-model="item.nextWorkPlan"></Input></td>
            <td><Input type="textarea" placeholder="" v-model="item.personLiable"></Input></td>
            <td>
              <Row>
                <Col span="14">
                  <Input type="textarea" placeholder=""  v-model="item.remark"></Input>
