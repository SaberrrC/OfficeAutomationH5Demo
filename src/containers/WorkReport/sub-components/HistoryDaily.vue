<template>
  <div class="no-rate-daily">
    <Card shadow>
      ...
      <div slot="extra">
        日期
        <DatePicker type="date" placeholder="Select date" style="width: 200px" @on-open-change="func" readonly v-model="reportData.time"></DatePicker>
      </div>
      <div class="card">
        <Row>
          <Col span="24">
...
export default {
  ...
  methods: {
    ...
    goBack () {
      location.hash = '/work_report/history/historyList'
    }
