    ...
    <div class="nav">
      ...
      <div>
        ...
        <div class="contents">
          ...
          <span>
            <Row>
              <i-Col :lg="{span:12}" :md="{span:13}" :sm="{span:13}" :xs="{span:14}" >
                  <row>
              ...
              <i-Col :lg="{span:8,offset:4}" :md="{span:10,offset:1}" :sm="{span:10,offset:1}" :xs="{span:10,offset:0}" style="text-align: right;padding-right: 16px">
